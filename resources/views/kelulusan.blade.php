...
@section('content')
<h3 class="mb-3 mt-0">Kelulusan Mahasiswa</h3>
<div class="row my-4">
    <div class="col-lg-6 col-md-12 md-mb-0 mb-4">
        <div class="card">
            <div class="card-header pb-0">
                <h6>Statistik Semester Mahasiswa Telat Lulus</h6>
            </div>
            <div class="card-body p-3">
                <div id="pie_semester"></div>
            </div>
        </div>
    </div>
    <div class="col-lg-6 col-md-12 md-mb-0 mb-4">
        <div class="card">
            <div class="card-header pb-0">
                <h6>Statistik Angkatan Mahasiswa Telat Lulus</h6>
            </div>
            <div class="card-body p-3">
...
<div class="row my-4">
    <div class="col-lg-12 col-md-12 mb-md-0 mb-4">
        <div class="card">
            <div class="card-header pb-0">
                <h6>Statistik Mahasiswa Telat Lulus</h6>
            </div>
            <div class="card-body p-3">
...
<script type="text/javascript">
    ...
    google.charts.load('current', {
                ...
                function drawChart() {
                    ...
                    var chart1 = new google.visualization.PieChart(document.getElementById('pie_semester'));
                    chart1.draw(data1);
                    // ------------------------------------
